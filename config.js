...
const DEFAULT_TARGET = '' // 必填，拷貝默認目的地ID，如果不指定target，則會覆制到此處，建議填寫團隊盤ID

const AUTH = { // 如果您擁有service account的json授權文件，可將其拷貝至 sa 目錄中以代替 client_id/secret/refrest_token
  ...
  tg_whitelist: ['your_tg_username'] // 你的tg username(t.me/username)，bot只會執行這個列表里的用戶所發送的指令
}
